...
- Foreign Key: `ClassID`  
  _On Delete: SET NULL, On Update: SET NULL_
- Foreign Key: `RaceID`  
  _On Delete: SET NULL, On Update: SET NULL_
...
- Foreign Keys:
  - `ClassID` (_On Delete: CASCADE, On Update: CASCADE_)
  - `SpellID` (_On Delete: CASCADE, On Update: CASCADE_)
...
- Foreign Keys:
  - `CharacterID` (_On Delete: CASCADE, On Update: CASCADE_)
  - `EquipmentID` (_On Delete: CASCADE, On Update: CASCADE_)
...
- Foreign Keys:
  - `CharacterID` (_On Delete: CASCADE, On Update: CASCADE_)
  - `EventID` (_On Delete: CASCADE, On Update: CASCADE_)
...
- Foreign Keys:
  - `PlayerID` (_On Delete: CASCADE, On Update: CASCADE_)
  - `AchievementID` (_On Delete: CASCADE, On Update: CASCADE_)
